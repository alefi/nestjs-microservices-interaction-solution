...
import { userServiceGrpcServerOptions } from './config';

async function main() {
  const app = await NestFactory.createMicroservice<MicroserviceOptions>(AppModule, userServiceGrpcServerOptions);
